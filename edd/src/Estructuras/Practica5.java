...
public class Practica5{
  ...
  public static void main(String[] args) {
    ...
    MonticuloMinimo<Entero> min = new MonticuloMinimo<Entero>(
      lista1,
      lista1.size()
    );
    ...
    System.out.println();
    System.out.println(
      "Prueba del metodo MontMax_MontMin \nEl arreglo que convertimos es:"
    );
    ...
    System.out.println(
      "La coleccion con la cual construimos el monticulo maximo es:" + lista3
    );
    ...
    for (k = 0; k < 3; k++) {
      ...
      System.out.println();
      System.out.println(
        "El monticulo maximo despues de hacer el add es:" + max
      );
    }
    System.out.println();
    ...
    for (k = 0; k < 3; k++) {
      System.out.println(
        "El monticulo maximo antes de hacer el delete es:" + max
      );
      System.out.println();
      max.delete();
      System.out.println(
        "El monticulo maximo despues de hacer el delete es:" + max
      );
    }
    System.out.println();
    System.out.println(
    ...
    System.out.println();
    System.out.println(
      "Prueba del metodo MontMin_MontMax\nEl arreglo que convertimos es:"
    );
